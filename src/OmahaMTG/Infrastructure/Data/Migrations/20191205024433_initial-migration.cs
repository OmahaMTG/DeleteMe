        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDraft = table.Column<bool>(nullable: false),
                    VimeoId = table.Column<string>(nullable: true),
                    MeetingHostId = table.Column<int>(nullable: true),
                    HostMeetingBody = table.Column<string>(nullable: true),
                    MeetingMarkdownBody = table.Column<string>(nullable: true),
                    MeetingHtmlBody = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SponsorId = table.Column<int>(nullable: false),
                    MeetingSponsorBody = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingRSVPs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresenterPresentationBody = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
